...
class AssitantSetting extends StatefulWidget {
  const AssitantSetting({super.key});

  @override
  State<AssitantSetting> createState() => _AssitantSettingState();
}

class _AssitantSettingState extends State<AssitantSetting> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
            ...
            child: Column(children: [buildTop(), buildSettingsBox()])),
  ...
  Widget buildSettingsBox() {
    return Container(
        ...
        child: Column(children: [setNewUsername(), clearHistory()]));
  }

  Widget setNewUsername() {
    return Padding(
        ...
        child: Column(children: [
          ...
          ElevatedButton(
              ...
              child: _isChanging
                  ...
                  : Text(_label ? 'Name changed' : 'Change name',
                      style: const TextStyle(
    ...
    return Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          ...
          Container(
              ...
              child: const Text('Assistant settings',
                  style: TextStyle(
                      color: Colors.black,
                      fontFamily: 'Inter-Medium',
                      fontSize: 16))),
  ...
  void _changeUsername() async {
    ...
    setAssistantName(username: username);
  ...
  void deleteChat() async {
    await databaseHelperDialog.clearTable();
  }
}
